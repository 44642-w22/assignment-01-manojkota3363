...
int y=sc.nextInt();
		System.out.println("Output (L2): "+Obj1.problem2(L2, y));
...
for(int i=0;i<n2;i++) {
	L3.add(sc.nextInt());
		...
		System.out.println("Output:"+Obj1.problem3(L3));
		...
		System.out.println("Output (A2): "+Obj1.problem4(L4));
		System.out.println("enter the String pattern");

		String s=sc.nextLine();	
		System.out.println("******problem5******");

		System.out.println("Output: "+Obj1.problem05(s));
		...
		System.out.println("Output (A): "+Obj1.problem6(S1));
		...
		System.out.println("Output: "+Obj1.problem7(Q1));
		...
		System.out.println("Output (A): "+Obj1.problem8(Q2));
		...
		System.out.println("Output (A): "+Obj1.problem9(Q3));
		...
		//Integer[] arr = {1, 1, 0};
		System.out.println("Output :"+Obj1.problem10(Q4,arr));
